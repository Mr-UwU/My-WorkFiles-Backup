...
SELECT main.*
                        ...
                        CASE
                            ...
                            THEN (
                                ROUND(
                                    ...
                                    pos.fcustomer_count
                                    *
                                    (pos.fcustomer_count - (pos.fcustomer_count * pos.fscratio))
                                , 4)
                            )
                            ELSE (
                                ROUND(
    ...
    WHERE main.Tax_Sale <> main.ExpctdTaxSale2
        OR main.VAT_EXEMPT <> main.ExpctdVatExempt2;
    -- --------------------------------------------------------------------------------------------------------------