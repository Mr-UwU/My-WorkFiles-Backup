                ...
                CASE
                    ...
                    ELSE (
                        CASE 
                            ...
                            ELSE (ROUND((pos.fsubtotal / pos.fcustomer_count) * (pos.fcustomer_count - COALESCE(senior_data.senior_count, 0)), 2) - (CASE WHEN pos.fexc_sale<>0 OR pos.finc_sale<>0 THEN pos.ftotal_discount ELSE 0 END)) / 1.12 * 0.12
                        END            
                    )
                END AS DECIMAL(16,6)
            ) AS ExpctdSalesTax
